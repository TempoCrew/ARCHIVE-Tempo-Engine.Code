...
class CrashLog
{
	...
	public static function init()
	{
		...
		#if (cpp && !debug) // for debug build removed this, because... this for debug no cool :D
	...
	static function standardError(e:UncaughtErrorEvent)
	{
		...
		engine.backend.api.DiscordClient.instance.shutdown();
		#end
...
private class CrashReference
{
	...
	{
		#if windows
		final appName:String = (openfl.Lib.application.meta.get('file') != null ? openfl.Lib.application.meta.get('file') : 'TempoEngine') + ".exe";
		final parentDir:String = Sys.programPath().substr(0, Sys.programPath().length - appName.length) + 'engine\\windows\\crash_dialog\\';
